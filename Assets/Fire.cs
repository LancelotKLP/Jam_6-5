...
{
    public int gridWidth = 320; // Increase the width to match the desired resolution
    public int gridHeight = 240; // Increase the height to match the desired resolution
    public int cellSize = 1; // Each cell will be 1 pixel in the texture
    ...
    void InitializeColors()
    {
        ...
        {
            new Color32(0, 0, 0, 0), // Transparent color for the background
